...
public class EducationalListAdapter extends RecyclerView.Adapter<EducationalListAdapter.ViewHolder> {

    Context context;
    ArrayList<AffiliationDataModel> arrayData;

    public EducationalListAdapter(Context context, ArrayList<AffiliationDataModel> arrayData){
