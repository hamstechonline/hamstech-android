...
public class CareerOptionsPopupListAdapter extends RecyclerView.Adapter<CareerOptionsPopupListAdapter.ViewHolder> {

    Context context;
    ArrayList<CourseDataModel> careerData;

    public CareerOptionsPopupListAdapter(Context context, ArrayList<CourseDataModel> careerData){
